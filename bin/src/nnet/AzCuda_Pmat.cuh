...
#include "AzP.h"
  ...
  void azccall_set_subcol_sub_divcol(AzFloat *dst, int r_num, int c_num, 
                                 const AzFloat *mat0, const AzFloat *vecA, 
                                 const AzFloat *mat1, const AzFloat *vecB); 
  void azccall_set_square(AzFloat *dst, int num, const AzFloat *src);                                   
  void azccall_to_binlogi_deriv(AzFloat *p, int num, AzFloat y); 
  void azccall_logloss(const AzFloat *p, int num, const AzFloat *y, AzFloat *deriv, AzFloat *loss);   
