...
public: 
  ...
  static void _add_col(AzFloat *dst, int r_num, int c_num, const AzFloat *src, AzFloat coeff) {
    azccall_add_col(dst, r_num, c_num, src, coeff); 
  }
  static void _add_row(AzFloat *dst, int r_num, int c_num, const AzFloat *src, AzFloat coeff) {
    azccall_add_row(dst, r_num, c_num, src, coeff); 
  }  
  ...
  /*---  update for Adam  ---*/
  static void _adam_delta(int num, AzFloat *g1, const AzFloat *g2, AzFloat b1t, AzFloat b2t, AzFloat eps, bool do_variant) {
    azccall_adam_delta(num, g1, g2, b1t, b2t, eps, do_variant); 
  }
  ...
  static void _mark_ge_colth(AzFloat *dst, int r_num, int c_num, const AzFloat *col_th, AzFloat coeff) { 
    azccall_mark_ge_colth(dst, r_num, c_num, col_th, coeff); 
  }  
  static void _set_onehot(AzFloat *dst, int r_num, int c_num, const int *rows, AzFloat val) {  
    azccall_set_onehot(dst, r_num, c_num, rows, val); 
  }
  ...
  /*---------------------------------------------------------------------------*/
  static void _set_subcol_divcol(AzFloat *dst, int r_num, int c_num, 
                                 const AzFloat *src, const AzFloat *vecA, const AzFloat *vecB) {
    azccall_set_subcol_divcol(dst, r_num, c_num, src, vecA, vecB); 
  }                                 
  static void _set_mulcol_addcol(AzFloat *dst, int r_num, int c_num, 
                                 const AzFloat *src, const AzFloat *vecA, const AzFloat *vecB) {
    azccall_set_mulcol_addcol(dst, r_num, c_num, src, vecA, vecB); 
  }                                 
  static void _set_mulcol(AzFloat *dst, int r_num, int c_num, const AzFloat *src, const AzFloat *vecA) {
    azccall_set_mulcol(dst, r_num, c_num, src, vecA); 
  }
  static void _set_mul(AzFloat *dst, int num, const AzFloat *src0, const AzFloat *src1) {
    azccall_set_mul(dst, num, src0, src1); 
  }
  static void _set_subcol_sub_divcol(AzFloat *dst, int r_num, int c_num, 
       const AzFloat *mat0, const AzFloat *vecA, const AzFloat *mat1, const AzFloat *vecB) {
    azccall_set_subcol_sub_divcol(dst, r_num, c_num, mat0, vecA, mat1, vecB); 
  } 
  static void _set_square(AzFloat *dst, int num, const AzFloat *src) { azccall_set_square(dst, num, src); } 
  static void _to_binlogi_deriv(AzFloat *p, int num, AzFloat y) {  
    azccall_to_binlogi_deriv(p, num, y); 
  }
  static void _logloss(const AzFloat *p, int num, const AzFloat *y, AzFloat *deriv, AzFloat *loss) {
    azccall_logloss(p, num, y, deriv, loss); 
  }
  static void _get_diagonal(const AzFloat *src, int rc_num, AzFloat *dst) { azccall_get_diagonal(src, rc_num, dst); }  
  static void _set_diagonal(const AzFloat *src, int rc_num, AzFloat *dst) { azccall_set_diagonal(src, rc_num, dst); }
  static void _add_diagonal(const AzFloat *src, int rc_num, AzFloat *dst) { azccall_add_diagonal(src, rc_num, dst); }
#ifdef __AZ_EIGEN__
  static void _sym1_eigen(AzFloat *inoutA, int rc_num, AzFloat *lams, bool do_valueonly, int *devinfo) {
    _sym2_eigen(inoutA, NULL, rc_num, false, lams, do_valueonly, devinfo); 
  }
  static void _sym2_eigen(AzFloat *inoutA, AzFloat *inoutB, int rc_num, bool do_AxBx, 
                          AzFloat *lams, bool do_valueonly, int *devinfo);
  static void _dbl_sym_eigen(double *inoutA, int rc_num, double *lams, bool do_valueonly, int *devinfo);                            
#ifdef __AZ_CUDA9__                          
  static void _symj_eigen(AzFloat *inoutA, int rc_num, AzFloat *lambdas, bool do_valueonly, int *devinfo); 
#endif                           
#endif 
protected: 
