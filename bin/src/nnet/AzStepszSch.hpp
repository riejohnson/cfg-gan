...
public: 
  ...
  #define kw_aa_old "step_size_a="
  #define kw_bb_old "step_size_b="
  #define kw_cc_old "step_size_c="
  #define kw_aa "ss_a="
  #define kw_bb "ss_b="
  #define kw_cc "ss_c="  
  ...
  void resetParam(AzParam &azp, const char *pfx="") {
    ...
    if (typ == AzStepszSch_Type_None) {}
      ...
      azp.vStr(kw_decay_at, &s_decay_at, kw_decay_at_old, kw_aa_old);
      azp.vFloat(kw_decay_factor, &decay_factor, kw_decay_factor_old, kw_bb_old);
      ...
      /*---  Tinv (t inverse): eta (1 + (b^{-1/c}-1)/a t)^{-c} ... reaches eta*b after a epochs ---*/
      cc = 1; /* default */      
      azp.vFloat(kw_aa, &aa, kw_aa_old);
      azp.vFloat(kw_bb, &bb, kw_bb_old);
      azp.vFloat(kw_cc, &cc, kw_cc_old); 
