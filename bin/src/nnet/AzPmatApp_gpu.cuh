...
public:
  ...
  inline static void _pooling_max_up2(int data_num, 
                         const AzFloat *elm1, int width1, 
                         AzFloat *elm2, int width2, 
                         int row_num, 
                         const int *_chosen) { /* must not be NULL */
    azcparam_pooling_max p(data_num, elm1, width1, elm2, width2, row_num, NULL, 0, -1, NULL); 
    azccall_pooling_max_up2(p, _chosen);     
  }
  ...
  inline static void _pooling_max_var_up2(const azcparam_var &p, int cnum2, const int *_chosen) { 
    azccall_pooling_max_var_up2(p, cnum2, _chosen); 
  }  
