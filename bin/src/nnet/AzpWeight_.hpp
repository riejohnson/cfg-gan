...
public: 
  ...
  /*---  up and down ...  ---*/
  virtual void upward(bool is_test, const AzPmat *m_x, AzPmat *m_out, const AzpLm_i *lmi=NULL) = 0; 
  virtual void upward(bool is_test, const AzPmatSpa *m_x, AzPmat *m_out) = 0; 
  virtual void downward(const AzPmat *m_lossd, AzPmat *m_d, const AzpLm_i *lmi=NULL) const = 0; 
  virtual void updateDelta(int d_num, const AzPmat *m_x, const AzPmat *m_lossd, const AzpLm_i *lmi=NULL) = 0; 
  virtual void updateDelta(int d_num, const AzPmatSpa *m_x, const AzPmat *m_lossd, const AzpLm_i *lmi=NULL) = 0; 
